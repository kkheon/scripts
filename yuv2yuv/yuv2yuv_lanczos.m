...
function yuv2yuv_lanczos(File_old,width_old,height_old,format_old,File_new,width_new,height_new,format_new)
    ...
    if mod(framenumber,1) ~= 0
        ...
        for cntf = 1:1:framenumber
            ...
            YUV_new = imresize(YUV,[height_new width_new],'lanczos3');
